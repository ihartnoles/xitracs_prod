class WizardController < ApplicationController
  ...
  def faculty
    ...
    if (session[:search_mode] == "department") 
  ...
  def show_courses_for
    ...
    #find coursedocuments (syllabi)
    #@coursedocuments = Coursedocument.find(:first,:conditions => {:course_id =>course_ids,:semester_id => session[:semester_id],:faculty_id => faculty_id})
